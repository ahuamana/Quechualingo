        ...
        this.innerHTML = `
            <section class="waiting-list">
                <div class="container">
                    ...
                    <div class="waiting-list__message alert alert-success mt-3 d-none" role="alert"></div>
                </div>
            </section>
        `;
    }
...
customElements.define('waiting-list-form', WaitingListForm);

const formContainer = document.getElementById('waiting-list-form');
formContainer.innerHTML = '<waiting-list-form></waiting-list-form>';